...
function projectpage1(){
    window.open('https://github.com/umangraval/Smart-Checkout-App', '_blank');
}
function projectpage2(){
    window.open('https://github.com/MeMihir/nCoViD-Viz', '_blank');
}
function projectpage3(){
    window.open('https://github.com/aashraya18/Virtual_Tutoring_App', '_blank');
}
function projectpage4(){
    window.open('https://colab.research.google.com/gist/MeMihir/ac6bad08468962fd273afc5e9000220d/copy-of-genetic-algo-parallalized.ipynb#scrollTo=fZSl-6CH7am7', '_blank');
}
...
function resumeRoute() {
    window.open('https://drive.google.com/file/d/13bB78UmoQUUPpj7oT8EsMC0NzqAeMWw1/view?usp=sharing', '_blank');
